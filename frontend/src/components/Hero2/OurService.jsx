...
const Services = () => {
  const services = [
    {
      number: "01",
      title: "Intelligent Virtual Consultations",
      description:
        "Our telehealth services provide convenient access to healthcare.",
      icon:<StetoScope/> ,
    },
    {
      number: "02",
      title: "Intuitive Appointment Booking",
      description:
        "We make booking appointments hassle-free for doctors & patients.",
      icon: <StetoScope/>,
    },
    {
      number: "03",
    ...
    {
      number: "04",
      title: "AI Telehealth & Telemedicine Chatbot",
      description:
        "Experience the power of AI in healthcare with our ultimate chatbot.",
      icon: "<icon1/>",
    },
    {
      number: "05",
      ...
      description:
        "Track your health metrics in real-time from the comfort of your home.",
      icon: "📊",
    },
    {
      number: "06",
      title: "AI-powered Diagnosis Assistance",
      description: "Advanced AI algorithms to support accurate diagnosis.",
      icon: "🧬",
    },
  ];
        ...
        <div className="rounded-[5vw] bg-gray-100 p-[5%]">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-[2.5vh]">
              Explore the range of services we offer to enhance your healthcare
              experience.
            </p>
          </div>
