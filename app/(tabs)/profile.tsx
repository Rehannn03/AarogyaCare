...
import { Settings, ChevronRight, Bell, Shield, HelpCircle, LogOut, Share2, Download } from "lucide-react-native"
...
export default function ProfileScreen() {
  ...
  const handleExportData = () => {
    Alert.alert(
      "Export Medical Data",
      "This will export your medication data and medical history in a format that can be shared with healthcare providers.",
      [
        {
          text: "Cancel",
          style: "cancel",
        },
        {
          text: "Export",
          onPress: () => {
            // This would actually export data in a real app
            setTimeout(() => {
              Alert.alert("Success", "Your medical data has been exported successfully.")
            }, 1000)
          },
        },
      ],
        ...
        <ThemedView style={styles.menuSection}>
          ...
          <ThemedView style={[styles.menuCard, { backgroundColor: cardBgColor }]}>
            <MenuItem
              ...
              onPress={() => {
                Alert.alert("Share Data", "This would open sharing options in a real app")
              }}
            />
